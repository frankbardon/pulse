...
// Schema. It is a reserved name under the cohort scheme (no .pulse suffix, so
// it never collides with a cohort file) — the same contract published at the
// github.io docs URL and emitted by `pulse schema`.
