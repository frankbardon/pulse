...
func TestDomainCodes(t *testing.T) {
	domains := map[string][]perr.Code{
		...
		"PROCESSING_": {
			...
			perr.PROCESSING_REGRESSION_NOT_IMPLEMENTED,
			perr.PROCESSING_REGRESSION_RANK_DEFICIENT,
			perr.PROCESSING_REGRESSION_NO_CONVERGE,
			perr.PROCESSING_REGRESSION_SINGULAR_GRAM,
			perr.PROCESSING_REGRESSION_INVALID_FAMILY,
			perr.PROCESSING_REGRESSION_INVALID_LINK,
			perr.PROCESSING_REGRESSION_INSUFFICIENT_DATA,
		},
		"SERVICE_": {
